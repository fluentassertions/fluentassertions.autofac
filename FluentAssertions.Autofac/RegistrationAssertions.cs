...
public class RegistrationAssertions : ReferenceTypeAssertions<IComponentContext, RegistrationAssertions>
{
    ...
    /// <summary>
    ///     Asserts that the current service type has been registered as singleton on the current
    ///     <see cref="IComponentContext" />.
    /// </summary>
    ...
    /// <summary>
    ///     Asserts the current service type has been registered with auto activation on the current
    ///     <see cref="IComponentContext" />.
    /// </summary>

...
var project = Argument("project", "./FluentAssertions.Autofac.sln");
    ...
    .Does(() =>
{
    ...
    DotNetCoreNuGetPush($"./artifacts/FluentAssertions.Autofac.{gitVersion.NuGetVersion}.nupkg", new DotNetCoreNuGetPushSettings {
